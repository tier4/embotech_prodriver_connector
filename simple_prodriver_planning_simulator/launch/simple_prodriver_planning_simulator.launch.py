...
def launch_setup(context, *args, **kwargs):
    ...
    simple_prodriver_planning_simulator_node = Node(
        package="simple_prodriver_planning_simulator",
        executable="simple_prodriver_planning_simulator_exe",
        name="simple_prodriver_planning_simulator",
    ...
    group = GroupAction([simple_prodriver_planning_simulator_node, map_to_odom_tf_publisher])
...
def generate_launch_description():
    ...
    add_launch_arg(
        "vehicle_characteristics_param_file",
        [
            FindPackageShare("simple_prodriver_planning_simulator"),
    ...
    add_launch_arg(
        ...
        [
            FindPackageShare("simple_prodriver_planning_simulator"),
            "/param/simple_prodriver_planning_simulator_default.param.yaml",
        ],
