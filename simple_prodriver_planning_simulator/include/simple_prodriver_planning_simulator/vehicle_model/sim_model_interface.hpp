...
#ifndef SIMPLE_PRODRIVER_PLANNING_SIMULATOR__VEHICLE_MODEL__SIM_MODEL_INTERFACE_HPP_
#define SIMPLE_PRODRIVER_PLANNING_SIMULATOR__VEHICLE_MODEL__SIM_MODEL_INTERFACE_HPP_
 ...
 * @brief simple_prodriver_planning_simulator vehicle model class to calculate vehicle dynamics
 */
class SimModelInterface
{
protected:
...
#endif  // SIMPLE_PRODRIVER_PLANNING_SIMULATOR__VEHICLE_MODEL__SIM_MODEL_INTERFACE_HPP_
